function [matchedCoordinates]=displacementCalc_recursive_2010_09_09(reference,deformed,numNeighbors,numVectorsRef,numVectorsDef,tol,numProcessors,jm)
...
while(length(matchedCoordinates_New)/length(matchedCoordinates)>.01)
