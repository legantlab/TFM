...
dispVectorSource = 1;
pointforce_rad = 3;             % radius of point force, in um
pointforce_load = -1;           % load of point force, as a ratio of gel modulus
pointforce_direction = 3;           % direction of point force, 1 for x, 2 for y and 3 for z
pointforce_coord = [0 35 25];        %center of applied force
...
runName = [today '_channel_top3525_R1_L1_Z_gnoise'];
...
%       uAllTimes = {u};
        ...
        BeadDispSaveAsFile = ['../COMSOL/Force_recon_simulation/BeadDisp_' runName '.mat'];
...
saveas(gcf, ['../COMSOL/Force_recon_simulation/' runName 'Solutinoheatmap_temp.fig'])
%}