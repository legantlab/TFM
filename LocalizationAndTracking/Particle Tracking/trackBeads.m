...
% [x, track, translation] = trackBeads(fileInfo, beadParameter, tptParam)
...
%             in the current directory. Input options: --- If the image is
%             not within a cell --- 1) fileInfo{c}{1} = 'filename*.mat' or
%             'filename'
%
%             --- If image is within a cell (Recommended approach) --- 2)
%             fileInfo{c}{1} = 'filename*.mat' or 'filename'
...
%              Input options: 1) beadParam{c}.thres = value between 0 & 1.
%              (Default 0.5)
%                                      default value = 0.5
%
