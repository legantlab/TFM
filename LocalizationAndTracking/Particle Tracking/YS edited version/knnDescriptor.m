...
%unitD = fillmissing(unitD,'constant',max(unitD));              % added by Yu 2/5/2020 to fix the NAN problem in D matrix
%Throwing random errors so I commented it out -MH 6/30/2020
