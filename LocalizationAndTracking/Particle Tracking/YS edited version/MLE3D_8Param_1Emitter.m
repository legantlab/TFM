function [pn,r,delta,u]=MLE3D_8Param_1Emitter(PSF1,p_initial)
%Note sigmoids are not actually being fit/updated, this needs to be fixed -
%MH 06/2023
p_initial = double(p_initial);
PSF1 = double(PSF1);
iters=60;
r=0;
% delta=0;
...
pn=[Io,xo,yo,zo,bg,sigx,sigy,sigz];
