...
close all
%Load in image
I = loadtiff('U:\Max\2023_06_07_DragonflyPSFTesting\BeadZStacks\Green\400nmZ\Small\63x_Ixon1x_ZStack400nmFull-1-1.tif');
I2 = loadtiff('U:\Max\2023_06_07_DragonflyPSFTesting\BeadZStacks\Green\400nmZ\Small\63x_Ixon1x_ZStack400nmFull-1-2.tif');
...
zbPass = 15;%linspace(30,70, 9);
bPassParams{1} = [.75,.75,.75];
bPassParams{3} = [0,0];
%Store images
